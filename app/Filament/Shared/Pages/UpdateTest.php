...
/**
 * Added in 1.0.8 purely to prove the one-click updater delivers new code:
 * after updating, this page appearing in the sidebar is the proof. Safe to
 * delete (and unregister from both panel providers) once that's confirmed.
 */
