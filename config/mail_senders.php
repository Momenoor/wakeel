...
return [
    'senders' => [
        'iflas' => [
            ...
            'password' => env('MAIL_SENDER_IFLAS_PASSWORD'),
                    ...
                    <tbody>
                      <tr>
                        <td style="padding: 0; vertical-align: top;">
                          ...
                          <p style="margin: 0; font-family: Calibri, sans-serif; font-size: 12pt;">
                            <span style="color: #1f3864;"><b>مكتب الخبير الحسابى والمحكم الدولي</b></span>
                          </p>
                          <p style="margin: 0; font-family: Calibri, sans-serif; font-size: 12pt;">
                          ...
                          <p style="margin: 0; font-family: Calibri, sans-serif; font-size: 9pt;">
                            ...
                            <span style="color: #1f3864;">&nbsp;+971 56 107 5965&nbsp;&nbsp;&nbsp;</span></b>
        ...
        'haikala' => [
            ...
            'password' => env('MAIL_SENDER_HAIKALA_PASSWORD'),
            'host' => 'mail.jpaemirates.com',
            'port' => 587,
            'encryption' => 'tls',
            'signature' => <<<'HTML'
        ...
        'easar' => [
            ...
            'password' => env('MAIL_SENDER_EASAR_PASSWORD'),
            'host' => 'mail.jpaemirates.com',
            'port' => 587,
            'encryption' => 'tls',
            'signature' => <<<'HTML'
